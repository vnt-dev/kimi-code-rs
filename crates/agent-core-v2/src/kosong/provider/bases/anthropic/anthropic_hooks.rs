...
use crate::kosong::protocol::protocol_trait::{JsonObject, ResolvedTrait, ThinkingHookOptions};
...
mod tests {
    ...
    use crate::kosong::protocol::protocol_trait::{ProtocolTrait, TraitContext};

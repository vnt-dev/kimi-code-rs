...
use crate::_base::errors::codes::{CORE_INTERNAL, ErrorDomain, ErrorInfo, register_error_domain};
use crate::_base::errors::errors::{Error2, Error2Options, ErrorCause};
...
pub fn translate_provider_error(error: ProviderBoundaryError) -> Result<Error2, ChatProviderError> {
    ...
    match error {
        ...
        ProviderBoundaryError::Provider(error)
            if crate::kosong::contract::errors::is_abort_error(&error) =>
        {
            Err(crate::kosong::contract::errors::create_abort_error())
        }
...
mod tests {
    ...
    use crate::_base::errors::errors::ErrorCause;
